<div class="flex flex-col">
    <div class="flex flex-row h-[100px]">
       ...
       <div>
            <!-- <div class="ml-[520px] mt-[20px] border rounded rounded-lg border-[4px] border-[#cf3434]">
    ...
    <div class="flex flex-col mt-[40px]">
       ...
       <div class="flex flex-row mt-[40px] ml-[170px]">
            <div class="flex flex-col border rounded-lg ml-[30px] w-[350px] h-[390px] text-center items-center py-[10px]">
                ...
                <span class="mt-[10px]">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad id, nemo cumque quia delectus quaerat assumenda. Labore animi dolores architecto consectetur a laboriosam quibusdam nesciunt excepturi temporibus vero, eaque distinctio?
                </span>
                <div class="font-semibold text-lg underline underline-offset-8 mt-[30px]">
                    Try it
                </div>
            </div>
            <div class="flex flex-col border rounded-lg ml-[30px] w-[350px] h-[390px] text-center items-center py-[10px]">
    ...
    <div class="flex flex-col bg-[#5C001F] h-fill w-fill mt-[40px] items-center">
        ...
        <div class="text-white font-bold my-[5px] text-center text-2xl">
            Malaysia Big Data Research Excellent Consortium (BiDaREC)
        </div>
        <div class="flex flex-row space-x-10 mt-[30px]">
            <img class="w-[250px] h-[90px]" src="{{ asset('images/KPT.png') }}">
            <img class="w-[250px] h-[90px]" src="{{ asset('images/UM.png') }}">
            <img class="w-[250px] h-[90px]" src="{{ asset('images/UTM.png') }}">
            <img class="w-[160px] h-[90px]" src="{{ asset('images/UTeM.png') }}">
        </div>
    </div>
</div>
