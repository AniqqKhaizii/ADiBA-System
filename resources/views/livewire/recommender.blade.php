<div class="flex flex-col">
    ...
    <div class="flex flex-row">
        <button name="1st" class="focus:ring-green-400 focus:ring-4 flex flex-col mt-[20px] w-[575px] h-fill border rounded-lg bg-gray-100 text-black sapce-y-[20px]">
            ...
            <span class="text-md my-[10px] mx-[30px]">
                2. Average Wait Time: The y-axis represents the average wait time in minutes. 
            </span>
            <span class="text-md my-[10px] mx-[30px]">
            ...
            <span class=" text-md my-[10px] mx-[30px]">
            4. Data Points: Collect data on a regular basis (e.g., daily, weekly) for each department or clinic. 
            </span>
            <span class="text-md my-[10px] mx-[30px]">
            5. Tooltip Information: Provide the exact average wait time for that time period and the department or clinic it represents.
            </span>
            <span class="text-md my-[10px] mx-[30px]">
        ...
        <button name="2nd" class="flex flex-col mt-[20px] w-[569px] h-fill border rounded-lg bg-gray-100 ml-[30px]">
            <div class="font-bold text-3xl my-[20px] mx-[10px]">
                Staffing Levels
            </div>
            <div class="flex flex-row">
